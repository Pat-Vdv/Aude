...
libD.createXhrObject = function ()
{ // thanks http://fr.wikipedia.org/wiki/XMLHttpRequest
...
libD.request = function(method, url, callback, args, type, context)
{
	...
	var requestTimeout, send = function()
	{
		if(method === 'POST')
		{
		...
		else
		{
			...
			catch(e)
			{
				...
				{
					console.error('request could not be sent', e);
				}
			}
		}
