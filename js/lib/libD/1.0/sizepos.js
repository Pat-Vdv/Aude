...
*/
libD.borderWidth = function(o, side)
{// side is Left, Top, Bottom or Right (mind the Case !)
...
/*
	...
	var v, curleft = o.offsetLeft + libD.borderWidth(o, 'Left');

	while ((o = o.offsetParent) && o !== document)
	{
		curleft += o.offsetLeft + libD.borderWidth(o, 'Left');
	}
	return curleft;
*/
};
...
/*	if(o === document) return 0;
	...
	var v, curtop = o.offsetTop + libD.borderWidth(o, 'Top');

	while ((o = o.offsetParent) && o !== document)
	{
		curtop += o.offsetTop + libD.borderWidth(o, 'Top');
	}
	return curtop;
*/
};
...
/*if(window.opera)
{ //offsetTop and offsetLeft break with css transforms in opera. This code doesn't help.
	libD.left = function (o)
	{
		if(o === document) return 0;

		var mat = o.style.OTransform, notransf = '';
		o.style.OTransform = notransf;
		
		var v, curleft = o.offsetLeft + libD.borderWidth(o, 'Left');

		o.style.OTransform = mat;
		
		while ((o = o.offsetParent) && o !== document)
		{
			mat = o.style.OTransform;
			o.style.OTransform = notransf;
