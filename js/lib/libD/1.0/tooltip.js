...
libD.need(['fx'], function() {
	...
	*/
	libD.tooltip = function(html,e,timeout)
	{ // mouse event
		...
		if(html)
		{
			...
			libD.showQuietly(libD._tooltipElem, 300);
		}
	};
...
*/
	...
	{
		if(!libD._tooltipElem) return;

		libD.hideQuietly(libD._tooltipElem, {delay:300, time:250});
		if(e)
		{
			libD._tooltipElem.style.left = e.clientX + ( document.documentElement.scrollLeft || document.body.scrollLeft ) + 20 + 'px';
			libD._tooltipElem.style.top = e.clientY + ( document.documentElement.scrollTop || document.body.scrollTop ) +  20 + 'px';
...
/*
	...
	Parameter:
		e - a mouse event or any object that has clientX and clientY values in order to set the position of the tooltip correctly. In IE, window.event will be hecked if this parameter is not given.
*/
...
*/
	...
	{
		try {document.body.removeChild(libD._tooltipElem);delete libD._tooltipElem;}
		catch(e){}
	};
...
*/
	libD.tooltipBind = function(o, html, timeout)
	{
		...
		o._libD_tooltip_crap = function(e)
		{
			libD.tooltip(html, e);
			if(timeout)
		...
		libD.addEvent(o, 'mouseover', o._libD_tooltip_crap);
		libD.addEvent(o, 'mousemove', libD.tooltipPos);
		libD.addEvent(o, 'mouseout', libD.tooltipHide);
		libD.addEvent(o, 'mousedown', libD.tooltipHide);
	};
...
*/
	...
	{
		libD.removeEvent(o, 'mouseover', o._libD_tooltip_crap);
		libD.removeEvent(o, 'mousemove', libD.tooltipPos);
		libD.removeEvent(o, 'mouseout', libD.tooltipHide);
		libD.removeEvent(o, 'mousedown', libD.tooltipHide);
	};
