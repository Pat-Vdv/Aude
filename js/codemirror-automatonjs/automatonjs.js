...
CodeMirror.defineMode("automatonjs", function(config, parserConfig) {
  ...
  var keywords = function(){
    ...
    var jsKeywords = {
      ...
      "return": C, "break": C, "continue": C, "new": C, "delete": C, "throw": C,"include":C,
      "var": kw("var"), "const": kw("var"), "let": kw("var"),
      "function": kw("function"), "catch": kw("catch"),
      "for": kw("for"), "foreach": kw("foreach"), "switch": kw("switch"), "case": kw("case"), "default": kw("default"),
      "in": operator,"of": operator,"union": operator, "inter": operator, "minus": operator, "contains":operator, "subsetOf":operator,"elementOf":operator,"belongsTo":operator, "symDiff":operator, "typeof": operator, "instanceof": operator,
...
CodeMirror.defineMIME("text/x-automatonjs", "javascript");
