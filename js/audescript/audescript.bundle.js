...
var AudescriptASTBrace = (function (_super) {
    ...
    AudescriptASTBrace.prototype.toJS = function (right, left, assignment) {
        ...
        if (assignment === void 0) { assignment = false; }
        return (this.values
            ? _super.prototype.toJS.call(this, "{", "}", assignment)
            : (assignment
                ? _super.prototype.toJS.call(this, "[", "]", true)
...
var AudescriptASTFor = (function (_super) {
    ...
    function AudescriptASTFor(lexer, identifier, begin, end, downto, step, block) {
        _super.call(this, lexer);
    ...
    AudescriptASTFor.prototype.toJS = function () {
        ...
        return this.sourceNode([
            "for (let" + this.whiteBeforeId, id, this.whiteAfterId + "=", this.begin.toJS(), ";" + (this.whiteAfterBegin || " ") +
                id, this.downto ? " >=" : " <=", this.end.toJS(), "; ", id, (this.downto ? " -=" : " +=") + this.whiteAfterEnd, this.step.toJS(), ")" + this.whiteAfterStep + "{",
            this.block.toJS(), "}"
        ]);
    };
...
var AudescriptParser = (function () {
    ...
    AudescriptParser.prototype.parseFor = function (state) {
        ...
        var downto = !(this.lexer.tryEat("to") ||
            this.lexer.tryEat("upto") ||
            this.lexer.tryEat("up to"));
        if (downto && !this.lexer.tryEat("downto") && !this.lexer.tryEat("down to")) {
            this.lexer.parseError(format(_("Unexpected {0}, expecting 'to', 'upto', 'up to', 'downto' or 'down to'"), this.lexer.getWord(true)));
        }
        ...
        return new AudescriptASTFor(state, identifier, begin, end, downto, step, block);
    };
