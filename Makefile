...
clean-src:
	rm -rf Makefile js/lib/libD js/lib/libD/1.0/jso2dom.js js/lib/hammer.min.js js/mousewheel.js js/set.js js/automata.js js/automaton2dot.js js/audescript.js js/automatadesigner.js js/lib/fileSaver.js js/gui.js js/touch2click.js js/lib/codemirror/lib/codemirror.js js/codemirror-audescript/audescript.js
